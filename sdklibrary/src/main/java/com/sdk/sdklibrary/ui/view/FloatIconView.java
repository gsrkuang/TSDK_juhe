...
public class FloatIconView extends RelativeLayout {
     ...
     * 设置点击事件监听
     *
     * @param onFloatIconViewClickListener
     */
    public void setOnFloatIconViewClickListener(OnFloatIconViewClickListener onFloatIconViewClickListener) {
        this.onFloatIconViewClickListener = onFloatIconViewClickListener;
    }

    public interface OnFloatIconViewClickListener {
        void onItemClick();
    }
...
//        wm.removeViewImmediate(this);
    ...
    public void clickView(){
        onFloatIconViewClickListener.onItemClick();
